...
namespace Microsoft.Teams.Apps.ListSearch.Common.Models
{
    ...
    public class KBInfo : TableEntity
    {
        ...
        /// <summary>
        /// Gets encoded question field
        /// </summary>
        public string QuestionFieldDisplayName
        {
            get
            {
                return (this.QuestionField != null) ?
                    JsonConvert.DeserializeObject<ColumnInfo>(this.QuestionField)?.DisplayName : string.Empty;
            }
        }
